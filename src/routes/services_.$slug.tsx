...
function ServiceArticlePage() {
  ...
  // Sibling articles in same category
    ...
    <>
      <section className="bg-gradient-hero text-primary-foreground py-14">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <p className="mt-4 text-lg opacity-90 max-w-3xl">{article.lead}</p>
        </div>
      </section>
      ...
      {lightbox !== null && gallery.length > 0 && (
        ...
        >
          ...
          <figure className="max-w-5xl w-full" onClick={(e) => e.stopPropagation()}>
            <img src={gallery[lightbox].src} alt={gallery[lightbox].alt} className="w-full max-h-[78vh] object-contain rounded-xl" />
